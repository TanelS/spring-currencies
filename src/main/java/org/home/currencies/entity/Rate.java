...
@Table(name = "rate", indexes = {
        ...
        @Index(name = "idx_rate_currency_id", columnList = "currency_id"),
        @Index(name = "idx_rate_base_currency_id", columnList = "base_currency_id")
}, uniqueConstraints = {
        @UniqueConstraint(name = "uc_rate_currency_id",
                columnNames = {
                        "currency_id",
                        "base_currency_id",
                        "rateDate"
